      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              <h3 className="text-3xl font-bold text-gray-900 mb-8 animate-fade-in">Get in Touch</h3>
              ...
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    id="name"
                    name="name"
                    className="w-full px-4 py-3 border border-gray-300 rounded-2xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors duration-200"
                ...
                <button
                  type="submit"
                  className="w-full bg-amber-600 text-white py-3 px-6 rounded-2xl font-semibold hover:bg-amber-700 transition-colors duration-200 shadow-lg hover:shadow-xl"
                >
                  Send Message
                </button>
              </form>
